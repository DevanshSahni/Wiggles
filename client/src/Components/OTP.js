...
const OTP = () => {
  ...
  useEffect(()=>{
    ...
    emailjs.send(process.env.REACT_APP_SERVICE_ID, process.env.REACT_APP_TEMPLATE_ID_OTP, templateParams, process.env.REACT_APP_PUBLIC_API_KEY)
    .then((result) => {
      // showSuccessToast();
    }, (error) => {
      // showErrorToast();
    ...
    <div className='OTP'>
      ...
      <form onSubmit={(e)=>handleSubmit(e)}>
        ...
        <div className='OTPlink'>
          ...
          <span className='OTPResend' disabled>Resend code</span>
        </div>
